...
const TRANSLATIONS = {
  es: {
    ...
    sim_box_standby: '[EN ESPERA] Aguardando requerimiento entrante de pago de agente...',
  ...
  en: {
    ...
    sim_box_standby: '[STANDBY] Waiting for incoming agent payment requirement...',
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', () => window.PaygentI18n.init())
} else {
